...
/**
 * 
 * @description CMS修改类，在新闻中增加股票代码。
 * @version 1.0
 * @author wangaz
 * @update 2014-1-20 上午10:42:07
 */
public class NewsLetvPortlet extends ActionsoftWeb
{
  public static final int TITLE_LENGTH = 20;

  public NewsLetvPortlet(UserContext uc)
  {
    super(uc);
  }
    ...
    throws UnsupportedEncodingException
  {
    ...
    /**
     * 将title名称传到页面，供js调用，判断是否为新闻，然后展示股票信息。
     */
    hashTags.put("lexwtitle", channelConf);
    /**
     * #######################################结束####################
     */
    ...
    return RepleaseKey.replace(HtmlModelFactory.getHtmlModel("NewsLetvPortlet.htm"), hashTags);
  }
