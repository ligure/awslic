...
import com.letv.actionsoft.ws.impl.CrmServiceImpl;
import com.letv.actionsoft.ws.impl.PortalServiceImpl;

public class RMIServiceJob implements IJob {
	...
	private void startAWSRmi() {
		try {
			...
			ItemServer.bind(new AWSRemotePerformanceServer(),
					"performanceServer");
			ItemServer.bind(new PortalServiceImpl(), "portal");
			ItemServer.bind(new CrmServiceImpl(), "crm");
